...
<main>
	<div class="flex flex-col items-center lg:mt-10 lg:space-y-15">
		<section class="section grid grid-cols-1 items-center gap-5 lg:w-4xl lg:grid-cols-[1fr_auto]">
			...
			<div class="flex justify-center lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:justify-end">
				<img
					src="/slipper-dashboard-2026-04-09-lowres.png"
					alt="Slipper dashboard"
					class="w-64 lg:w-80"
				/>
			</div>
			<div class="col-start-1 flex flex-col space-y-5">
				...
				<p class="text-left text-lg">
					Slipper er Norges første uavhengige strømapp, laget av forbrukere for forbrukere. Appen
					hjelper deg å ta riktige strømvalg – og spare penger på strømavtalen, strømstøtte og
					nettleie.
				</p>
				<button
		...
		>
			<div class="flex flex-col items-center space-y-5">
				<h1 class="h1 base-font-color text-2xl">Det skal være superenkelt å ta gode strømvalg</h1>
				<div class="w-none lg:max-w-3xl">
					<p class="base-font-color text-lg">
						Appen samler alt på ett sted – fra strømavtaler og priser til strømstøtte, nettleie og
						forbruk. Få anbefalinger og varsler når noe lønner seg, så du enkelt kan ta riktige
						strømvalg og spare penger.
					</p>
				</div>
			</div>
			<div class="grid grid-cols-2 grid-rows-2 gap-10 md:grid-cols-4 md:grid-rows-1">
				<div class="flex max-w-[190px] flex-col items-center space-y-2">
					<HandCoins />
					<h5 class="h5 base-font-color">Billigste strømavtale</h5>
					<p class="text-md">Se billigste avtale for deg, og bytt når det lønner seg</p>
				</div>
				<div class="flex max-w-[190px] flex-col items-center space-y-2">
					<FileSearch />
					<h5 class="h5 base-font-color">Full oversikt</h5>
					<p class="text-md">Se forbruk, priser, nettleie og kostnader samlet</p>
				</div>
				<div class="flex max-w-[190px] flex-col items-center space-y-2">
					<Zap />
					<h5 class="h5 base-font-color">Bruk strøm smart</h5>
					<p class="text-md">Gode valg gir lavere strømpris og kostnader</p>
				</div>
				<div class="flex max-w-[190px] flex-col items-center space-y-2">
					<PiggyBank />
					<h5 class="h5 base-font-color">Se hva du sparer</h5>
					<p class="text-md">Følg med på hvor mye du sparer ved riktige valg</p>
				</div>
			</div>
		</section>
		...
		<section class="section mb-12 grid grid-cols-1 items-center gap-5 lg:w-4xl">
			...
			<div class="w-none col-start-1 flex flex-col justify-center lg:max-w-3xl">
				...
				<p class="mt-3 text-lg">
					I Slipper bestemmer du! Foreslå funksjoner, stem på idéer og vær med å bygge appen
					strømselskapene håper du aldri får høre om...
				</p>
			</div>
